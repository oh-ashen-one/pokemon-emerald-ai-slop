...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_SHROOMISH)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_NUMEL)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_CORPHISH)
