...
// Berries
    ...
    [ITEM_ORAN_BERRY] =
    {
        .name = ITEM_NAME("Cache Berry"),
        .pluralName = ITEM_PLURAL_NAME("Cache Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .holdEffect = HOLD_EFFECT_RESTORE_HP,
        .holdEffectParam = 10,
        .description = COMPOUND_STRING(
