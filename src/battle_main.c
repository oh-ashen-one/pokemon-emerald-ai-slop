...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AROMA_LADY] = { _("DEVREL"), 10 },
    ...
    [TRAINER_CLASS_POKEFAN] = { _("FANBOY"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("SCRIPT KID"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("LOG FISHER"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    ...
    [TRAINER_CLASS_TWINS] = { _("PAIR CODERS"), 3 },
    ...
    [TRAINER_CLASS_RIVAL] = { _("BALANCE QA"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG REPORTER"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("INTERN"), 4 },
